...
describe('Comments', function () {
  ...
  it('should include CSS multi-line comments', function (done) {
    compareFileOutput(testSCSSPath + '/comments-2.scss', done);
  });

  it('should not compile commented code', function (done) {
    compareFileOutput(testSCSSPath + '/comments-3.scss', done);
  });

  it('should include multi-line CSS commented blocks', function (done) {
